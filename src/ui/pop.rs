    ...
    B: Backend,
{
    ...
    match app.popup.poptype {
        ...
        Poptype::CreateDir => print_pop(f, app, String::from("Input which you want to create")),
        Poptype::CreateFile => print_pop(f, app, String::from("Input which you want to create")),
